function Connect-MSCloudLoginTeams
{
    ...
    {    
        if ($Global:appIdentityParams.CertificateThumbprint) 
        {
            ...
            Connect-MicrosoftTeams -TenantId $Global:appIdentityParams.Tenant -ApplicationId $Global:appIdentityParams.AppId -CertificateThumbprint $Global:appIdentityParams.CertificateThumbprint -TeamsEnvironmentName $envName -ErrorAction Stop | Out-Null
        }
        else
        {
